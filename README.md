...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5813&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sentry-sdk-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sentry-sdk` can be installed with `conda`:
...
```
mamba install sentry-sdk
```

It is possible to list all of the versions of `sentry-sdk` available on your platform with `conda`:
...
```
mamba search sentry-sdk --channel conda-forge
```
...
mamba repoquery search sentry-sdk --channel conda-forge

# List packages depending on `sentry-sdk`:
mamba repoquery whoneeds sentry-sdk --channel conda-forge

# List dependencies of `sentry-sdk`:
mamba repoquery depends sentry-sdk --channel conda-forge
```
